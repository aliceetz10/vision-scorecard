...
df = pd.read_csv('data/raw/unemployment-fetch.csv', skiprows=8, encoding='utf-8')
...
df_new.to_csv('data/processed/unemployment-cleaned.csv', index=False, encoding='utf-8-sig')